...
* [Spring Data MongoDB](https://docs.spring.io/spring-boot/3.5.11-SNAPSHOT/reference/data/nosql.html#data.nosql.mongodb)
* [Spring Security](https://docs.spring.io/spring-boot/3.5.11-SNAPSHOT/reference/web/spring-security.html)
* [Docker Compose Support](https://docs.spring.io/spring-boot/3.5.11-SNAPSHOT/reference/features/dev-services.html#features.dev-services.docker-compose)
